...
const Privacy: React.FC = () => (
  <Container>
    ...
    <p>It is ORG BATTLEGROUND's policy to respect your privacy regarding any information we may collect from you across the website.
</p>
...
</p>      <p>We don’t share any personally identifying information publicly or with third-parties, except when required to by law.
</p>
    ...
    <p>Your continued use of our website will be regarded as acceptance of our practices around privacy and personal information. If you have any questions about how we handle user data and personal information, feel free to contact us.
      ...
      This policy is effective as of August, 22, 2020.
  </Container>
)
